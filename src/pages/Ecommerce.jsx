  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        ...
        lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat 
        bg-cover bg-center"
        >
          ...
          {earningData.map((item) => (
            ...
            >
              ...
              <p className="mt-3">
                ...
                {/* bug found within dummy data -- item.pcColor does not render color changes */}
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl fomt-semibold">$93,353</span>
                  <span
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl fomt-semibold">$48,313</span>
                </p>
